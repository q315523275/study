...
@Form.create()
@connect(({ summerProjectAdd }) => ({ ...summerProjectAdd }))
class SummerProjectAdd extends Component {
  componentDidMount() {
    this.props.dispatch({ type: 'summerProjectAdd/getSelectList' })
  }
  ...
  render() {
    const { form: { getFieldDecorator }, gradeList, subjectList } = this.props
    return (
      <Card
...
export default SummerProjectAdd
